...
public class Challenge_4_LeapYear {

    /*
    Write a method isLeapYear with a parameter of type int named year. [done]

The parameter needs to be greater than or equal to 1 and less than or equal to 9999.[done]

If the parameter is not in that range return false.[done]
