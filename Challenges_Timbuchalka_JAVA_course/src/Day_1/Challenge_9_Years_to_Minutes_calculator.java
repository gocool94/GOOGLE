...
public class Challenge_9_Years_to_Minutes_calculator {
    ...
    public static void main(String[] args){
        ...
        /*
Write a method printYearsAndDays with parameter of type long named minutes.[done]
...
* The solution will not be accepted if there are extra spaces
    ...
    public static void printYearsAndDays(long minutes){
        ...
        if (minutes <= 0){
            ...
            long numberofdaysRemaining = numberofdays % 365;

            //print "561600 min = 1 y and 25 d"
            System.out.println(minutes +" min = "+ numberofYears + " y and " + numberofdaysRemaining + "d");
        }
