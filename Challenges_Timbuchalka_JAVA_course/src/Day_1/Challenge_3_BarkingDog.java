...
public class Challenge_3_BarkingDog {
...
Write a method shouldWakeUp that has 2 parameters.[Done]

1st parameter should be of type boolean and
be named barking it represents if our dog is currently barking.[Done]
2nd parameter represents the hour of the day and is of type int with the name hourOfDay and
has a valid range of 0-23.[done]
